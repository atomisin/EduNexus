                            ...
                            if not topic_row:
                                conn.execute(
                                    text("""
                                        ...
                                        VALUES (:id, :subject_id, :name, :description, :sort_order, :learning_outcomes, :is_active, NOW())
                                    """),
                                    {
                                        "id": str(uuid.uuid4()),
                                        "subject_id": subj_id,
                                ...
                                conn.execute(
                                    text("""
                                        UPDATE topics SET sort_order = :sort_order, learning_outcomes = :learning_outcomes WHERE id = :id
                                    """),
                                    {
                                        "id": topic_row[0],
                                        "sort_order": i,
