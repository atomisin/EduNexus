...
export const BASE_EXAM_SUBJECTS = {
  "ss_1": ["Mathematics", "English Language"],
  "ss_2": ["Mathematics", "English Language"],
  "ss_3": ["Mathematics", "English Language"],
  "waec": ["Mathematics", "English Language"],
  "neco": ["Mathematics", "English Language"],
  "jamb": ["Use of English"]
} as const;
...
export const JAMB_MAX_SUBJECTS = 4;

export const WAEC_NECO_RANGE = [7, 9];
